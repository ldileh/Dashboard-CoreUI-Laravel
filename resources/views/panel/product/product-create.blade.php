...
@section('title', 'Product: Create Data')
...
<div class="row">
    <div class="col-md-7">
        <div class="card">
            ...
            <form class="form-horizontal" action="{{ route('product.data.create') }}" method="post" aria-label="{{ __('Product') }}" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="file" name="image" class="form-control" id="input-image" value="{{ old('image') }}">
