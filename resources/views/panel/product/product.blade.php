        ...
        <div class="card">
            <div class="card-header clearfix">
                <div class="float-left">
                    <i class="icon icon-menu"></i> Data Product
                </div>

                <a class="btn btn-primary btn-sm float-right" href="{{ route('product.create') }}"><i class="fa fa-plus"></i> Create Product</a>
            </div>
                ...
                { data: 'created_at', name: 'created_at' },
                {
                    ...
                    render: function(data, type, row, meta){
                        return '<div class="btn-group btn-group-sm">' +
                            ...
                            '<a class="btn btn-primary" href="{{ url('panel/product') }}/'+data+'/edit"><i class="fa fa-pencil"></i></a>' +
                        '</div>';
                    }
                },
            ],
            ...
            vex.dialog.confirm({
                ...
                callback: function (responseDialog) {
                    if (responseDialog) {
                        // do request endpoint...
                        showLoading();
                        axios.delete("{{ url('panel/product') }}/" + value + "/delete")
