            ...
            <form class="form-horizontal" action="{{ route('business_unit.data.create') }}" method="post" aria-label="{{ __('Business Unit') }}">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <label class="col-md-2 col-form-label is-required" for="input-name">{{ __('Title') }}</label>
                        <div class="col-md-10">
                    ...
                    @if (!$parents->isEmpty())
                    <div class="form-group row">
                        <label class="col-md-2 col-form-label" for="input-business_unit">{{ __('Parent Unit Usaha') }}</label>
                        <div class="col-md-10">
                    ...
                    <div class="form-group row">
                        <label class="col-md-2 col-form-label" for="input-url_page">{{ __('Page Url') }}</label>
                        <div class="col-md-10">
                    ...
                    <div class="form-group row">
                        <label class="col-md-2 col-form-label" for="input-content">{{ __('Content') }}</label>
                        <div class="col-md-10">
                ...
                { data: 'created_at', name: 'created_at' },
                {
                    ...
                    render: function(data, type, row, meta){
                        return '<div class="btn-group btn-group-sm">' +
                            ...
                            '<button type="button" class="btn btn-primary button-copy" data-value="'+row.url_image+'" data-toggle="tooltip" title="Url Image Copied!"><i class="fa fa-copy"></i></button>' +
                        '</div>';
                    }
                },
            ],
