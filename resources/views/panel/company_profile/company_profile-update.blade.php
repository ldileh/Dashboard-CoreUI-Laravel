...
<div class="row">
    <div class="col-md-7">
        <div class="card">
            <div class="card-header"><i class="fa fa-th-list"></i> Form Halaman Company Profile</div>

            <form class="form-horizontal" action="{{ route('company_profile.data.change', $type->id) }}" method="post" aria-label="{{ __('News') }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <label class="form-label" for="input-content">Halaman : {{ $type->name }}</label>
                            <textarea name="content" class="form-control" id="input-content">{{ old('content') ? old('content') : $content }}</textarea>
