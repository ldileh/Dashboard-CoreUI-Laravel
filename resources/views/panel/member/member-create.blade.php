...
@section('title', 'Member: Create Data')
...
<div class="row">
    <div class="col-md-8">
        <div class="card">
            ...
            <form class="form-horizontal" action="{{ route('member.data.create') }}" method="post" aria-label="{{ __('Member') }}" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="name" class="form-control" id="input-name" maxlength="225" value="{{ old('name') }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="birth_place" class="form-control" id="input-birth_place" maxlength="191" value="{{ old('birth_place') }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="birth_date" class="form-control date-picker" id="input-birth_date" value="{{ old('birth_date') }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <select name="gender" id="input-gender" class="form-control form-select2">
                                @foreach ($gender as $key => $value)
                                <option value="{{ $key }}"@if ($key == old('gender'))
                                 selected='selected'
                                @endif >{{ $value }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="nik" class="form-control" id="input-nik" value="{{ old('nik') }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="profession" class="form-control" id="input-profession" value="{{ old('profession') }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="komunitas_adat" class="form-control" id="input-komunitas_adat" value="{{ old('komunitas_adat') }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <textarea name="address" id="input-address" class="form-control">{{ old('address') }}</textarea>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="tel" name="phone_number" class="form-control" id="input-phone_number" value="{{ old('phone_number') }}">
                    ...
                    <div class="form-group row">
                        <label class="col-md-3 col-form-label is-required" for="input-file_ktp">{{ __('File KTP') }}</label>
                        <div class="col-md-9">
                    ...
                    <div class="form-group row">
                        <label class="col-md-3 col-form-label is-required" for="input-file_pass_photo">{{ __('File Pass Photo') }}</label>
                        <div class="col-md-9">
