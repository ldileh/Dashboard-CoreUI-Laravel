...
<div class="row">
    <div class="col-md-8">
        <div class="card">
            ...
            <form class="form-horizontal" action="{{ route('video.data.edit', $data->id) }}" method="post" aria-label="{{ __('Video') }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="file" name="banner" class="form-control" id="input-banner" value="{{ old('banner') ? old('banner') : $data->banner }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="video_url" class="form-control" id="input-video_url" maxlength="225" value="{{ old('video_url') ? old('video_url') : $data->video_url }}">
