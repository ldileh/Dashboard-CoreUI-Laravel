        ...
        <div class="card">
            <div class="card-header clearfix">
                <div class="float-left">
                    <i class="icon icon-menu"></i> Data Video
                </div>

                <a class="btn btn-primary btn-sm float-right" href="{{ route('video.create') }}"><i class="fa fa-plus"></i> Create Video</a>
            </div>
                ...
                { data: 'created_at', name: 'created_at' },
                {
                    ...
                    render: function(data, type, row, meta){
                        return '<div class="btn-group btn-group-sm">' +
                            ...
                            '<a class="btn btn-primary" href="{{ url('panel/video') }}/'+data+'/edit"><i class="fa fa-pencil"></i></a>' +
                        '</div>';
                    }
                },
            ],
            ...
            vex.dialog.confirm({
                ...
                callback: function (responseDialog) {
                    if (responseDialog) {
                        // do request endpoint...
                        showLoading();
                        axios.delete("{{ url('panel/video') }}/" + value + "/delete")
